        ...
        <>
            <main>
                <Routes>
                    ...
                    <Route path='/leiders/Hernieuwers' element={<LeidingNummes groep='Herniewers' nummers={[{naam: "Kobe Holemans", number:"0499 30 40 12", img:"/images/rubskesLogo.png"}, {naam: "Tjen Ooms", number:"0470 39 44 72",img:"/images/rubskesLogo.png"}, {naam: "Luna Vervloessem", number:"0473 98 97 90", img:"/images/rubskesLogo.png"}]}/>} />
                </Routes>
            </main>
        </>
    );
