...
function Braggel() {
	...
	return (
		<>
			<div className="custom-shape-divider-top-1662392900">
				<svg
					data-name="Layer 1"
			...
			<div className="braggel" id="braggel">
				...
				<p>
					Hieronder vind je een overzicht van de beschikbare digitale edities. Is een maand niet
					zichtbaar? Helaas, dan staat de editie voor die maand nog niet online. Naast de
					maandelijkse edities, kan je hier ook de speciallekes, zoals onze Startbraggel voor nieuwe
